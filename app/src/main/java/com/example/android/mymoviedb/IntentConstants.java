...
/**
 * Created by Archita on 02-08-2017.
 */
...
public class IntentConstants {
    ...
    public static final String API_KEY = "e8fe74f0b4809fbdaad3e84e16b29559";
    public static final String LANGUAGE = "en-US";
    public static final String CATEGORY_A = "popular";
    public static final String CATEGORY_B = "top_rated";
    public static final String CATEGORY_C = "now_playing";
